...
import KiwiGym_createEnv_v4F_0
...
# on case2 directory run: tensorboard --logdir=logs/final --port=6006, then check on http://localhost:6006.
...
if __name__=="__main__":
    ...
    for model_name in ["kiwiGym-v4F", "kiwiGym-v4F_0"]:
