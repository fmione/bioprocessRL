...
from kiwiGym4O import kiwiGym

# %%
# Register this module as a gym environment. Once registered, the id is usable in gym.make().
register(
    id='kiwiGym-v4O_0',                                # call it whatever you want
    entry_point='KiwiGym_createEnv_v4O_0:kiwiGymEnv4O_0', # module_name:class_name
)

# Implement our own gym env, must inherit from gym.Env
# https://gymnasium.farama.org/api/env/
class kiwiGymEnv4O_0(gym.Env):
...
if __name__=="__main__":
    ...
    while(cnt<3):
        ...
        if(terminated):
            ...
            TH_param=np.array([1.2578, 0.43041, 0.6439,  2.2048,  0.4063,  0.1143*4,  0.1848*4,    287.74,    1.586*.7, 1.5874*.7,  0.3322*.75,  0.0371,  0.0818,  7.0767*0+5,  0.4242*0+.25, .1057*0+.5]+[850]*3+[90]*3)
            obs = env.reset()[0]
        cnt+=1
