...
from kiwiGym4E import kiwiGym
# %%
# Register this module as a gym environment. Once registered, the id is usable in gym.make().
register(
    id='kiwiGym-v4E',                                # call it whatever you want
    entry_point='KiwiGym_createEnv_v4E:kiwiGymEnv4E', # module_name:class_name
)

# Implement our own gym env, must inherit from gym.Env
# https://gymnasium.farama.org/api/env/
class kiwiGymEnv4E(gym.Env):
