...
register(
    id='kiwiGym-v5',                                # call it whatever you want
    entry_point='KiwiGym_createEnv_v5:kiwiGymEnv5', # module_name:class_name
)

# Implement our own gym env, must inherit from gym.Env
# https://gymnasium.farama.org/api/env/
class kiwiGymEnv5(gym.Env):
