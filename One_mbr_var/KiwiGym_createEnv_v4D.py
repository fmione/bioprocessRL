...
from kiwiGym4D import kiwiGym
# %%
# Register this module as a gym environment. Once registered, the id is usable in gym.make().
register(
    id='kiwiGym-v4D',                                # call it whatever you want
    entry_point='KiwiGym_createEnv_v4D:kiwiGymEnv4D', # module_name:class_name
)

# Implement our own gym env, must inherit from gym.Env
# https://gymnasium.farama.org/api/env/
class kiwiGymEnv4D(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        TH_param_mean=np.array([1.2578,0.43041, 0.6439,  2.2048,  0.4063,  0.1143,  0.1848,    287.74,    1.586, 1.5874,  0.3322,  0.0371,  0.0818,  7.0767,  0.4242, .1057]+[850]*1+[90]*1)
